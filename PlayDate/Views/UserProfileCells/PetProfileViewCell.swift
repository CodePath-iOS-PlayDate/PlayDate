...
class PetProfileViewCell: UITableViewCell {
    
    static let identifier = "PetProfileViewCell"
    ...
    private let nameLabel: UILabel = {
        let label = UILabel()
        label.textColor = Colors.blueGreen
    ...
    private func setupViews() {
        ...
        self.verticalStackView.addArrangedSubview(typeLabel)
        self.verticalStackView.addArrangedSubview(sexLabel)
        self.verticalStackView.addArrangedSubview(ageLabel)
